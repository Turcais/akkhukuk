/**
 * Marka ikonlari lucide-react'ten kaldirildigi icin kendi SVG'lerimizi
 * tutuyoruz. Hepsi 24x24 kutuda, currentColor ile boyanir.
 */

type IkonOzellikleri = { className?: string };

export function LinkedInIkonu({ className }: IkonOzellikleri) {
  return (
...
export function XIkonu({ className }: IkonOzellikleri) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className={className}>
      <path d="M18.24 2.25h3.31l-7.23 8.26 8.5 11.24h-6.65l-5.21-6.82-5.97 6.82H1.68l7.73-8.84L1.25 2.25h6.82l4.71 6.23 5.46-6.23Zm-1.16 17.52h1.83L7.02 4.13H5.06l12.02 15.64Z" />
    </svg>
  );
}

export function InstagramIkonu({ className }: IkonOzellikleri) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className={className}>
...
export function YouTubeIkonu({ className }: IkonOzellikleri) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className={className}>
...
export const sosyalIkonlar = {
  linkedin: { etiket: "LinkedIn", Ikon: LinkedInIkonu },
  x: { etiket: "X", Ikon: XIkonu },
  instagram: { etiket: "Instagram", Ikon: InstagramIkonu },
  youtube: { etiket: "YouTube", Ikon: YouTubeIkonu },
} as const;
